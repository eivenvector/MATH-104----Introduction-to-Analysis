...
\NewDocumentCommand{\tangent}{o o}{\T _{#2}(#1)}    % For tangent space
...
\DeclareMathSymbol{\llcurly}     {3}{mathb}{"CE} % The preceding lines are to use just the symbol \llcurly from mathabx package (which itself conflicts with amsmath)
